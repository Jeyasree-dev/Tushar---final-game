...
manjumpright=loadImage("run4.PNG")
building1img=loadImage("building.png")
building2img=loadImage("building.png")
bgimg=loadImage("download.jpg")
waterimg=loadImage("water.jpg")
obstacleimg=loadImage("rock.jpg")
healStoneimg=loadImage("healStone.jpg")
heart1img=loadImage("heart.jpg")
heart2img=loadImage("heart.jpg")
heart3img=loadImage("heart.jpg")
heart4img=loadImage("heart.jpg")
heart5img=loadImage("heart.jpg")
heart6img=loadImage("heart.jpg")
heart7img=loadImage("heart.jpg")
heart8img=loadImage("heart.jpg")
heart9img=loadImage("heart.jpg")
heart10img=loadImage("heart.jpg")
rockintroimg=loadImage("rock.jpg")
safeintroimg=loadImage("healStone.jpg")
moveimg=loadImage("arrow keys.png")
...
if(gamestate==="END"){
  ...
  /*if(mousePressedOver(reset)){
   ...
   stroke("red")
   textSize(50)
   text("Game_Over",150,180)
   textSize(30)
   text("Your Score: "+ score, 200,220);
   textSize(40)
   text("Refresh the Page to try Again", 50,260)
 //score=0
  //man.destroy();
